...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="<?php echo C('__PUBLICIMGADMIN__');?>/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />后台管理中心</h1>
  </div>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="<?php echo U('Index/page');?>" target="right"><span class="icon-caret-right"></span>案例中心</a></li>  
    <li><a href="<?php echo U('Index/adv');?>" target="right"><span class="icon-caret-right"></span>首页轮播</a></li>   
    <li><a href="<?php echo U('Index/book');?>" target="right"><span class="icon-caret-right"></span>留言管理</a></li>     
    <li><a href="<?php echo U('Index/column');?>" target="right"><span class="icon-caret-right"></span>栏目管理</a></li>
  </ul>   
  <h2><span class="icon-pencil-square-o"></span>栏目管理</h2>
  <ul>
    <li><a href="<?php echo U('Index/caseCenter');?>" target="right"><span class="icon-caret-right"></span>案例中心</a></li>
