...
<!-- saved from url=(0027)http://www.sdzs.com/?m=news -->
...
<div class="main">
	<div class="container">
		<div class="crumb"><a href="/">奥莎德首页</a>&nbsp;&gt;&nbsp;<span><a href="<?php echo U('Index/news');?>">新闻动态</a></span></div>
	</div>
	...
	<div class="container">
		<div class="news-pic-list">
			<ul class="list">
				<?php if(is_array($result["content"])): foreach($result["content"] as $key=>$item): ?><li>
						<a href="<?php echo U('Index/newsDetail');?>/newsId/<?php echo ($item["newsId"]); ?>" class="clearfix">
							<div class="pic pull-left"><img src="/Public/News/<?php echo ($item["newsId"]); ?>/1.jpg"></div>
							<h3><?php echo ($item["newsTitle"]); ?></h3>
							<h4><?php echo ($item["newsRelease"]); ?> 作者：<?php echo ($item["newsName"]); ?>  <?php echo ($item["newsTimes"]); ?>人浏览</h4>
							<p><?php echo (mb_substr($item["newsInfo"],0,100,'utf-8')); ?>...</p>
							<ins></ins>
						</a>
					</li><?php endforeach; endif; ?>
				<!--li>
					<a href="<?php echo U('Index/newsDetail');?>" class="clearfix">
						<div class="pic pull-left"><img src="/Public/Img/Home/1490841629863530.png"></div>
						<h3>客至｜温州材料商领导莅临圣都参观交流，共赢发展</h3>
						<h4>2017-03-30 来源：圣都装饰  30人浏览</h4>
						<p>有客从外来，闻之常欢喜。3月28日下午，圣都集团海外海精装体验城再逢贵客，喜迎浙江省温州市的材料商领导一行前来参观交流，共同商讨合...</p>
						<ins></ins>
					</a>
				</li>
				<li>
